...
export const ScheduleIdSchema = UlidSchema.brand("ScheduleId");
export const ScheduleOccurrenceIdSchema = UlidSchema.brand("ScheduleOccurrenceId");
...
export type ScheduleOccurrenceId = z.infer<typeof ScheduleOccurrenceIdSchema>;
