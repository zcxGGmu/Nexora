...
export const ERROR_CODES = ["AUTH_EXPIRED", "SCOPE_DENIED", "POLICY_REVIEW_REQUIRED", "RATE_LIMITED", "CONNECTOR_TIMEOUT", "SCHEMA_INVALID", "BUDGET_EXCEEDED", "DUPLICATE_SIDE_EFFECT", "RUNTIME_CRASHED", "STALE_LEASE", "REVIEW_STALE", "MEMORY_CONFLICT", "IDEMPOTENCY_KEY_REUSED", "CONNECTOR_UNAVAILABLE", "PROJECTION_DEGRADED", "EVENT_CURSOR_EXPIRED", "INVALID_STATE_TRANSITION", "VERSION_CONFLICT"] as const;
